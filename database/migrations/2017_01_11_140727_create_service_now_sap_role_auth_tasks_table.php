...
class CreateServiceNowSapRoleAuthTasksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_now_sap_role_auth_tasks', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->softDeletes();
            $table->text('task_id');
    ...
    {
        Schema::dropIfExists('service_now_sap_role_auth_tasks');
    }
}
