...
class CreateServiceNowIncidentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_now_incidents', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('service_now_incidents');
    }
}
