...
class CreateSecurityCenterCriticalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('security_center_criticals', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
			$table->softDeletes();
			$table->text('dns_name');
    ...
    {
        Schema::dropIfExists('security_center_criticals');
    }
}
