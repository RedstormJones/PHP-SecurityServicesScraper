...
class ProcessSecurityCenterCriticals extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'process:securitycentercriticals';
     ...
     * @var string
     */
    protected $description = 'Get new Security Center critical vulnerability data and update database';
    ...
    public function handle()
    {
		...
		$contents = file_get_contents(storage_path('logs/collections/sc_criticalvulns_collection.json'));
		...
		foreach($criticalvulns as $vuln)
		{
			...
			// create new critical vulnerability record
...
}	// end of ProcessSecurityCenterCriticals command class
