...
class CrawlInsideHostTrafficSnapshots extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crawl:insidehosttrafficsnapshots';
     ...
     * @var string
     */
    protected $description = 'run client to get snapshots of application traffic from inside hosts';
    ...
    public function handle()
    {
        ...
        echo 'collection count: '.count($app_dashboard_collection).PHP_EOL;
