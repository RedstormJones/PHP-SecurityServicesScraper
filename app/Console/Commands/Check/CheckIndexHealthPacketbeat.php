...
class CheckIndexHealthPacketbeat extends Command
{
    ...
    public function handle()
    {
        ...
        $log = new Logger('index_health_check_packetbeat');
        $log->pushHandler(new StreamHandler(storage_path('logs/checks/'.$today.'_index_health_check_packetbeat.log'), Logger::INFO));

        $log->info('Starting packetbeat Index Health Check!');
        ...
        $log->info('packetbeat index health check command completed!');
    }
