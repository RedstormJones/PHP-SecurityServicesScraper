    ...
    public function handle()
    {
        ...
        foreach ($device_threat_details as $threat_detail) {
            ...
            $result = $producer->send([
                [
                    'topic' => 'cylance_threat_details_suspicious',
        ...
        foreach ($device_threat_details as $device_threat) {
            $url = 'http://10.243.32.36:9200/cylance_threat_details_suspicious/cylance_threat_details_suspicious/';
