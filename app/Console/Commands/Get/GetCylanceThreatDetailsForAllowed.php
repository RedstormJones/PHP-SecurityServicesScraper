...
class GetCylanceThreatDetailsForAllowed extends Command
{
    ...
    public function handle()
    {
        ...
        file_put_contents(storage_path('app/collections/allowed_threat_details.json'), '');
        ...
        foreach ($device_threat_details as $data) {
            ...
            $contents = file_get_contents(storage_path('app/collections/allowed_threat_details.json'));

            // append JSON data string to current active threat contents and dump back to file
            file_put_contents(storage_path('app/collections/allowed_threat_details.json'), $contents.$json_data);
        }
        */
