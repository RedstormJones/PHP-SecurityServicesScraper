...
class GetIDMTasks extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:idmtasks';
    ...
    public function handle()
    {
        ...
        Log::info(PHP_EOL.PHP_EOL.'*******************************'.PHP_EOL.'* Starting IDM tasks crawler! *'.PHP_EOL.'*******************************');
        ...
        $assignment_group = urlencode('KTG OPS - Identity Management');
        ...
        if (array_key_exists('result', $content)) {
            ...
            Log::info('[+] GetIDMTasks - no results returned.');
        }
