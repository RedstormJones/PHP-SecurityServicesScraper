...
class ProcessSecurityCenterMediums extends Command
{
     ...
     * @var string
     */
    protected $signature = 'process:securitycentermediums';
     ...
     * @var string
     */
    protected $description = 'Get new Security Center medium vulnerability data and update database';
    ...
    public function handle()
    {
        ...
        $contents = file_get_contents(storage_path('logs/collections/sc_medvulns_collection.json'));
        $mediumvulns = \Metaclassing\Utility::decodeJson($contents);
