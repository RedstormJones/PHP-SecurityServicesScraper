...
class GetSAPRoleAuthTasks extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:saproleauthtasks';
     ...
     * @var string
     */
    protected $description = 'Get new SAP role auth tasks';
    ...
    {
        /*
         * [1] Get SAP role auth tasks
         */

        Log::info(PHP_EOL.PHP_EOL.'*****************************************'.PHP_EOL.'* Starting SAP role auth tasks crawler! *'.PHP_EOL.'*****************************************');
        ...
        Log::info(PHP_EOL.'********************************************'.PHP_EOL.'* Starting SAP role auth tasks processing! *'.PHP_EOL.'********************************************');

        foreach ($tasks as $task) {
            $exists = ServiceNowSapRoleAuthTask::where('sys_id', $task['sys_id'])->value('id');
        ...
        Log::info('* Completed ServiceNow SAP role auth tasks! *');
    }
