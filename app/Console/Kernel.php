...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('get:casalertshigh')->withoutOverlapping(2);
        $schedule->command('get:casalertsmedium')->withoutOverlapping(2);
        $schedule->command('get:casalertslow')->withoutOverlapping(2);
    }
