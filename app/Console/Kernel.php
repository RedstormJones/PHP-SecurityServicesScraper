...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
         ...
         */
        $schedule->command('get:proofpointsiem')->withoutOverlapping(2)->timezone('America/Chicago');
        $schedule->command('get:casalertshigh')->withoutOverlapping(2)->timezone('America/Chicago');
        $schedule->command('get:casalertsmedium')->withoutOverlapping(2)->timezone('America/Chicago');
        $schedule->command('get:casalertslow')->withoutOverlapping(2)->timezone('America/Chicago');
    }
